            ...
            <div key={p.id} className="bg-[#0f172a] border border-slate-800 rounded-[2.5rem] p-7 shadow-2xl transition-all hover:border-blue-500/30 group">
              <div className="flex justify-between items-center mb-6">
                <div className="flex flex-col items-center w-2/5 text-center">
                  <img src={p.home_logo || "/placeholder.png"} className="w-16 h-16 object-contain mb-2" alt="L" />
                  <span className="text-[10px] font-bold uppercase">{p.home_team}</span>
                </div>
                ...
                <div className="flex flex-col items-center w-2/5 text-center">
                  ...
                  <span className="text-[10px] font-bold uppercase">{p.away_team}</span>
                </div>
              </div>
              <div className="mb-8 p-4 bg-black/40 rounded-2xl border border-slate-800 text-left">
                <p className="text-slate-300 text-xs italic leading-relaxed">"{p.prediction || "Analyse en cours..."}"</p>
              </div>
              <div className="flex justify-between items-end border-t border-slate-800/50 pt-6">
                <div>
                  <p className="text-[10px] font-bold text-slate-500 uppercase">Confiance</p>
                  <p className="text-3xl font-black text-blue-500">{p.probability}%</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-slate-500 uppercase">Cote</p>
