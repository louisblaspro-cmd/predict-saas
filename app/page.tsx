  ...
  return (
    <main className="min-h-screen bg-[#020617] text-white p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-5xl font-black mb-12 italic text-blue-500 tracking-tighter text-center">Scout Intelligence 2.0 🚀</h1>
            ...
            <div key={p.id} className="bg-[#0f172a] border border-slate-800 rounded-[2.5rem] p-7 shadow-2xl transition-all hover:border-blue-500/30">
              <div className="flex justify-between items-center mb-8">
                <div className="flex flex-col items-center w-2/5 text-center">
                  <img src={p.home_logo || "https://placehold.co/64"} className="w-16 h-16 object-contain mb-3" alt="L" />
                  <span className="text-[10px] font-bold uppercase">{p.home_team || "Home"}</span>
                </div>
                <div className="text-xl font-black italic text-slate-600">VS</div>
                <div className="flex flex-col items-center w-2/5 text-center">
                  <img src={p.away_logo || "https://placehold.co/64"} className="w-16 h-16 object-contain mb-3" alt="R" />
                  <span className="text-[10px] font-bold uppercase">{p.away_team || "Away"}</span>
                </div>
              </div>
              <div className="mb-8 p-4 bg-slate-900/50 rounded-2xl border border-slate-800">
                <p className="text-slate-300 text-xs italic leading-relaxed">"{p.prediction || "Analyse IA en cours..."}"</p>
              </div>
